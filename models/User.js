...
let User = (() => {
    let _classDecorators = [(0, pg_core_1.Table)('users')];
    ...
    (() => {
        ...
        _id_decorators = [(0, pg_core_1.PrimaryKey)()];
        _username_decorators = [(0, pg_core_1.Column)()];
        _email_decorators = [(0, pg_core_1.Column)()];
        _password_decorators = [(0, pg_core_1.Column)()];
